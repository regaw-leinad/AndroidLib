...
namespace RegawMOD.Android
{
    ...
    {
        private const string ANDROID_CONTROLLER_TMP_FOLDER = "AndroidController\\";
        ...
        private AndroidController()
        {
            ...
            // Console.WriteLine("Utils.binDir: " + Utils.binDir);
            this.resourceDirectory = Path.Combine(Utils.binDir, ANDROID_CONTROLLER_TMP_FOLDER);
        }
